...
var mediumdutydieselvehicles = new mongoose.Schema({
...
mediumdutydieselvehicles.plugin(timestamps);
module.exports = mongoose.model('mediumdutydieselvehicles', mediumdutydieselvehicles );