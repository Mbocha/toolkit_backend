...
var PassengerGasolineVehicle= new mongoose.Schema({
...
PassengerGasolineVehicle.plugin(timestamps);
module.exports = mongoose.model('PassengerGasolineVehicle', PassengerGasolineVehicle);