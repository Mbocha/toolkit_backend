...
var passengersmalldieseltruck= new mongoose.Schema({
...
passengersmalldieseltruck.plugin(timestamps);
module.exports = mongoose.model('passengersmalldieseltruck', passengersmalldieseltruck);  