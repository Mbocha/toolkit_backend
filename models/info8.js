...
var LightDutyGasolineVehicle= new mongoose.Schema({
...
LightDutyGasolineVehicle.plugin(timestamps);
module.exports = mongoose.model('LightDutyGasolineVehicle', LightDutyGasolineVehicle);