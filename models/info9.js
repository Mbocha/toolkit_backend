...
var lightdutydieselvehicles = new mongoose.Schema({
...
lightdutydieselvehicles.plugin(timestamps);
module.exports = mongoose.model('lightdutydieselvehicles', lightdutydieselvehicles );